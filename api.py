        ...
        if request.method == "POST":
            ...
            if '://' in s:
                ...
                if tool == 'clash':
                        ...
                        api2 = 'https://api.wateraini.top/sub?target=clash&url={sub}'.format(sub=str(sub)) 
        ...
        if request.method == "POST":
            ...
            if '://' in s:
                ...
                if tool == 'clash':
                        ...
                        api2 = 'https://api.wateraini.top/sub?target=clash&url={sub}&ruleset={rulesets}&groups={groups}'.format(sub=str(sub),groups=groups,rulesets=rulesets) 
                ...
                if tool == 'clashr':
                        ...
                        api2 = 'https://api.wateraini.top/sub?target=clashr&url={sub}&ruleset={rulesets}&groups={groups}'.format(sub=str(sub),groups=groups,rulesets=rulesets) 
                ...
                if tool == 'surge':
                        ...
                        api2 = 'https://api.wateraini.top/sub?target=surge&url={sub}&ruleset={rulesets}&groups={groups}&ver=4'.format(sub=str(sub),groups=groups,rulesets=rulesets) 
                ...
                if tool == 'mellow':
                        ...
                        api2 = 'https://api.wateraini.top/sub?target=mellow&url={sub}&ruleset={rulesets}&groups={groups}'.format(sub=str(sub),groups=groups,rulesets=rulesets) 
                ...
                if tool == 'surfboard':
                        ...
                        api2 = 'https://api.wateraini.top/sub?target=surfboard&url={sub}&ruleset={rulesets}&groups={groups}'.format(sub=str(sub),groups=groups,rulesets=rulesets) 
